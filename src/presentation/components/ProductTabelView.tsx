...
import { Box, Button, ButtonGroup, Card, IconButton, Modal, TextField, Typography } from "@mui/material";
...
const ProductTabelView: React.FC<myProps> = ({ data, category }) => {
  ...
  return(
    <Box>
    <table width="100%" style={{ paddingTop: "3%" }}>
        ...
        <Button variant="outlined" onClick={handleOpen} endIcon={<AddIcon />} color="warning">Add Product</Button>
        </div>
